...
var Swiper = function Swiper(node) {
  ...
  root.ontouchmove = function (e) {
    ...
    clock = setTimeout(function () {
      ...
      if (newX - initX > 30) {
        eventHub['swiperRight'].forEach(function (fn) {
          return fn.bind(root)();
        });
      } else if (newX - initX < 30) {
        eventHub['swiperLeft'].forEach(function (fn) {
          return fn.bind(root)();
        });
      }
    }, 100);
...
},{}],"src/image/musicqrcode.png":[function(require,module,exports) {
module.exports = "/musicqrcode.93ef01e0.png";
...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    value: function start() {
      ...
      fetch('https://axdo.github.io/data-mock//huali-music/music-list.json').then(function (res) {
        return res.json();
      }).then(function (data) {
        console.log(data);
        _this2.songList = data;
        _this2.songTitle = data.map(function (song) {
          return song.title;
        });

        _this2.loadTitle();

        _this2.loadSong(); // this.liBind()
    ...
    value: function loadTitle() {
      ...
      for (var i = 0; i < this.songTitle.length; i++) {
        var title = document.createElement('li');
        title.classList.add('song-name#' + i); //需要把文本设置在li节点里，否则就会出现<li></li>歌名，可能会影响绑定点击事件

        title.innerText = this.songTitle[i]; // this.$('#song-list').append(this.songTitle[i],title)

        this.$('#song-list').append(title);
      }

      this.$('#song-list').style.visibility = 'hidden'; //事件委托
    ...
    value: function bind() {
      ...
      this.$('.btn-music-list').onclick = function () {
        var button = document.querySelector('#song-list');
        console.log('hi');
        button.style.visibility === 'hidden' ? button.style.visibility = 'visible' : button.style.visibility = 'hidden'; // if(this.$('#song-title').style.visibility === 'hidden'){
    ...
    value: function loadLyrics() {
      ...
      fetch(this.songList[this.currentIndex].lyric).then(function (res) {
        ...
        _this7.setLyrics(data.lrc.lyric);
...
},{"./icons.js":"src/javascript/icons.js","./swiper.js":"src/javascript/swiper.js","../image/musicqrcode.png":"src/image/musicqrcode.png"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
